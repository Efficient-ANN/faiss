...
${DEMO_DIR}/demo_imipq_gpu_sift_m 128 16 8 8 ${BIGANN_DIR}/bigann_learn.bvecs 128 ${BIGANN_DIR}/bigann_base.bvecs 256 ${BIGANN_DIR}/bigann_base.bvecs 0 "" 0 1 6 7 6 7 0 8 2 1 4194304 ${RESULT_DIR}/coarse/coarse_imipq16_128_m_replica.bin ${RESULT_DIR}/index/index_imipq16_128_m_replica_256.bin 0 0 0 1 1 | tee ${RESULT_DIR}/outs/1_gpus_imipq256_16_128_m_shard_4MB_2_gpu_128_debugPrints_prof_simple.txt
