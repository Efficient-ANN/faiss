...
module load cuda/11.4 # for nvprof
...
ldd /petrobr/parceirosbr/petrobrasiageo/willian.barreiros/git/a/faiss_imipq/build/faiss/gpu/demos/demo_imipq_gpu_sift_m
