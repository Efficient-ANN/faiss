...
module load boost/1.73_gnu cmake/3.17.3 gcc/10.2 cuda/11.8 gcc/7.4 nvhpc/22.3
...
${DEMO_DIR}/demo_ivfpq_gpu_sift_m 128 126491 8 8 ${BIGANN_DIR}/bigann_learn.bvecs 32381696 ${BIGANN_DIR}/bigann_base.bvecs 250000000 ${BIGANN_DIR}/bigann_base.bvecs 0 "" 12 13 0 12 0 11 0 1 16 1 1 28991029248 ${RESULT_DIR}/coarse/coarse_ivfpq126491_32M.bin ${RESULT_DIR}/index/index_ivfpq126491_32M_250M.bin 1 0 0 3 | tee ${RESULT_DIR}/outs/ivfpq_multi_gpu_test_shard1_1gpu.txt
