...
${DEMO_DIR}/demo_imipq_gpu_sift_m 128 126491 8 8 ${BIGANN_DIR}/bigann_learn.bvecs 32381696 ${BIGANN_DIR}/bigann_base.bvecs 1000000000 ${BIGANN_DIR}/bigann_base.bvecs 0 "" 12 13 0 12 0 11 0 1 16 1 0 28991029248 ${RESULT_DIR}/coarse/coarse_ivfpq126491_32M.bin ${RESULT_DIR}/index/index_ivfpq126491_32M.bin 0 0 0 0 | tee ${RESULT_DIR}/outs/ivfpq_multi_gpu_test_shard_index.txt
