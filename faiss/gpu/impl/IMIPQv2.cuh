...
/// Implementing class for IMIPQv2 on the GPU
class IMIPQv2 : public IMIBasev2 {
public:
  ...
  /// our database
  void query(Tensor<float, 2, true> &queries, int nprobe, int k,
  ...
  void runCalcTerm3(Tensor<float, 2, true> &queries,
...
protected:
  ...
  void appendVectors_(Tensor<float, 2, true> &vecs,
                      ...
                      Tensor<int, 1, true> &listOffset, cudaStream_t stream);
  ...
  void runPQPrecomputedCodes_(Tensor<float, 2, true> &queries,
                              ...
                              int k, Tensor<float, 2, true> &outDistances,
                              Tensor<Index::idx_t, 2, true> &outIndices);
