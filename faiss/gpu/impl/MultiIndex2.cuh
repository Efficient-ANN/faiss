...
public:
  ...
  void query(Tensor<float, 2, true> &subQueries, int k,
             Tensor<float, 2, true> &outDistances,
             Tensor<int2, 2, true> &outIndices, bool exactDistance);

  void query(Tensor<float, 2, true> &subQueries, int k,
             Tensor<float, 2, true> &outDistances,
             Tensor<ushort2, 2, true> &outIndices, bool exactDistance);

  void query(Tensor<float, 2, true> &subQueries, int k,
             Tensor<float, 2, true> &outDistances,
             Tensor<Index::idx_t, 2, true> &outIndices, bool exactDistance);
...
private:
  ...
  void queryImpl(Tensor<float, 2, true> &subQueries, int k,
                 Tensor<float, 2, true> &outDistances,
                 Tensor<IndexTVect2, 2, true> &outIndices, bool exactDistance);
